...
const Form: FC = () => {
  ...
  const submitHandler = (e: FormEvent<HTMLFormElement>) => {
    ...
    let file = formData.stepThree.image.fileValue
      ...
      {step === 4 && (
        <Preview
          ...
          data={[
            {
              label: "First name",
              value: guard(formData.stepOne.firstName.value),
            },
            {
              label: "Last name",
              value: guard(formData.stepOne.lastName.value),
            },
            { label: "Email", value: guard(formData.stepTwo.email.value) },
            {
              label: "Password",
              value: guard(formData.stepTwo.password.value),
            },
